...
const config: Config = {
  ...
  theme: {
    extend: {
      // Custom Design Tokens for Education Portal
      colors: {
        // Primary Brand Colors (Blue and Green tones for focus)
        primary: {
          50: "#eff6ff",
          100: "#dbeafe",
          200: "#bfdbfe",
        ...
        // Neutral Colors for Study Theme
        neutral: {
          50: "#fafafa",
          100: "#f5f5f5",
          200: "#e5e5e5",
      ...
      boxShadow: {
        ...
        "nav-lg": "0 4px 6px -1px rgb(0 0 0 / 0.1), 0 2px 4px -2px rgb(0 0 0 / 0.1)",

        // Popover shadows
        popover: "0 10px 15px -3px rgb(0 0 0 / 0.1), 0 4px 6px -4px rgb(0 0 0 / 0.1)",
        "popover-lg": "0 25px 50px -12px rgb(0 0 0 / 0.25)",
